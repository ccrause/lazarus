...
constructor TDbgAvrProcess.Create(const AName: string; const AProcessID,
  AThreadID: Integer);
begin
...
begin
  ...
  dbg := TDbgAvrProcess.Create(AFileName, 0, 0);
  try
...
initialization
  ...
  FpDbgClasses.RegisterDbgProcessClass(TDbgAvrProcess);
